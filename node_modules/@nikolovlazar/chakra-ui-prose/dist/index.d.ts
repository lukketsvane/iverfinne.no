import { BoxProps, ComponentSingleStyleConfig, ThemeExtension } from '@chakra-ui/react';

declare type ProseProps = BoxProps;
declare function Prose(props: ProseProps): JSX.Element;
...
declare function withProse(themeOverride?: ComponentSingleStyleConfig): ThemeExtension;

export { Prose, ProseProps, withProse };
