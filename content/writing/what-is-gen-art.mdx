---
title: "Exploring Generative Art: Definitions & Types"
...
Header image: [Forecast #23](https://www.fxhash.xyz/gentk/FX0-1556245)
...
![vera_molnar_interruptions.png](/images/what-is-generative-art/vera_molnar_interruptions.png)
...
Noise is an effective way to create organic looking movement and shapes. Here are two of my pieces from [Genuary 2022](https://genuary.art/) which rely heavily on noise to generate the values for their variables.
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  ...
  <div style={{ width: '33.33%', padding: '5px' }}>
    <img src="/images/what-is-generative-art/sol_lewitt_wall_drawing_interactive.png" alt="Interactive Sol LeWitt Wall Drawing" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '33.33%', padding: '5px' }}>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
  <div style={{ width: '30%', padding: '5px' }}>
    <img src="/images/what-is-generative-art/conway-1.gif" alt="3 phase pulsar" style={{ width: '100%' }} />
    <p style={{ textAlign: 'center' }}>3 phase pulsar</p>
  </div>
  <div style={{ width: '30%', padding: '5px' }}>
    <img src="/images/what-is-generative-art/conway-2.gif" alt="Finite pattern" style={{ width: '100%' }} />
    <p style={{ textAlign: 'center' }}>Finite pattern</p>
  </div>
  <div style={{ width: '30%', padding: '5px' }}>
    <img src="/images/what-is-generative-art/conway-3.gif" alt="Gliders" style={{ width: '100%' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="/images/what-is-generative-art/myriad_tulips.png" alt="Myriad (Tulips) (2018) - Anna Ridler" style={{ width: '100%', marginBottom: '10px' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="/images/what-is-generative-art/paul_emile_borduas_untitled.jpg" alt="Untitled (1954-55) - Paul Emile Borduas" style={{ width: '100%', marginBottom: '10px' }} />
