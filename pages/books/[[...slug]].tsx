...
interface ReadingProps { books: Book[]; book?: Content<Book>; }
...
Reading.getLayout = (page: JSX.Element) => (<Layout><Flex direction="column" gap={8}><Readinghelf books={page.props.books} /><Divider />{page}</Flex></Layout>);
