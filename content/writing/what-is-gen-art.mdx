...
Experience my implementation of Conway's Game of Life [here](https://editor.p5js.org/iverfinne/sketches/ObizzlZni). Be sure to initiate the simulation by clicking the play button in the top left and familiarize yourself with the controls outlined at the top of the code.
